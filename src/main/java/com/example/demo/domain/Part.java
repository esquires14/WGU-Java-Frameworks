...
public abstract class Part implements Serializable {
    ...
    @Min(value = 0, message = "Minimum inventory must be zero or greater")
    int minInv;

    @Min(value = 0, message = "Maximum inventory must be zero or greater")
    int maxInv;
    ...
    public boolean isInventoryWithinRange() {
